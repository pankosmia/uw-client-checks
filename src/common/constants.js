...
export const DEFAULT_ORIG_LANG_OWNER = 'en'
export const IMPORTS_PATH = "burrito/ingredient/raw/_local_/_local_/%Project%?ipath=";
export const IMPORTS_PATH_BATCH = "burrito/ingredients/raw/_local_/_local_/%Project%?ipath=";
export const DELETE_PATH = "/burrito/ingredients/delete/%Project%?ipath="
export const DELETE_INGREDIENT_PATH = "/burrito/ingredient/delete/%Project%?ipath="
...
export const T_NOTES_CATEGORIES = {
  discourse: {
