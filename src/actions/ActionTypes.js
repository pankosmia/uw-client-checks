...
const ActionTypes = {
  ...
  UPDATE_PROJECT_VALIDATION_NEXT_BUTTON_STATUS:
    "UPDATE_PROJECT_VALIDATION_NEXT_BUTTON_STATUS",
  ...
  SAVE_BOOK_ID_AND_BOOK_NAME_IN_MANIFEST:
    "SAVE_BOOK_ID_AND_BOOK_NAME_IN_MANIFEST",
  ...
  SET_BOOK_ID_IN_PROJECT_INFORMATION_REDUCER:
    "SET_BOOK_ID_IN_PROJECT_INFORMATION_REDUCER",
  SET_RESOURCE_ID_IN_PROJECT_INFORMATION_REDUCER:
    "SET_RESOURCE_ID_IN_PROJECT_INFORMATION_REDUCER",
  SET_NICKNAME_IN_PROJECT_INFORMATION_REDUCER:
    "SET_NICKNAME_IN_PROJECT_INFORMATION_REDUCER",
  SET_LANGUAGE_ID_IN_PROJECT_INFORMATION_REDUCER:
    "SET_LANGUAGE_ID_IN_PROJECT_INFORMATION_REDUCER",
  SET_LANGUAGE_NAME_IN_PROJECT_INFORMATION_REDUCER:
    "SET_LANGUAGE_NAME_IN_PROJECT_INFORMATION_REDUCER",
  SET_LANGUAGE_DIRECTION_IN_PROJECT_INFORMATION_REDUCER:
    "SET_LANGUAGE_DIRECTION_IN_PROJECT_INFORMATION_REDUCER",
  SET_ALL_LANGUAGE_INFO_IN_PROJECT_INFORMATION_REDUCER:
    "SET_ALL_LANGUAGE_INFO_IN_PROJECT_INFORMATION_REDUCER",
  SET_CONTRIBUTORS_IN_PROJECT_INFORMATION_REDUCER:
    "SET_CONTRIBUTORS_IN_PROJECT_INFORMATION_REDUCER",
  SET_CHECKERS_IN_PROJECT_INFORMATION_REDUCER:
    "SET_CHECKERS_IN_PROJECT_INFORMATION_REDUCER",
  SET_ALREADY_IMPORTED_IN_PROJECT_INFORMATION_CHECK_REDUCER:
    "SET_ALREADY_IMPORTED_IN_PROJECT_INFORMATION_CHECK_REDUCER",
  SET_USFM_PROJECT_IN_PROJECT_INFORMATION_CHECK_REDUCER:
    "SET_USFM_PROJECT_IN_PROJECT_INFORMATION_CHECK_REDUCER",
  SET_LOCAL_IMPORT_IN_PROJECT_INFORMATION_CHECK_REDUCER:
    "SET_LOCAL_IMPORT_IN_PROJECT_INFORMATION_CHECK_REDUCER",
  SET_OVERWRITE_PERMITTED_IN_PROJECT_INFORMATION_CHECK_REDUCER:
    "SET_OVERWRITE_PERMITTED_IN_PROJECT_INFORMATION_CHECK_REDUCER",
  SET_SKIP_PROJECT_NAME_CHECK_IN_PROJECT_INFORMATION_CHECK_REDUCER:
    "SET_SKIP_PROJECT_NAME_CHECK_IN_PROJECT_INFORMATION_CHECK_REDUCER",
  SET_PROJECT_FONT_IN_PROJECT_INFORMATION_REDUCER:
    "SET_PROJECT_FONT_IN_PROJECT_INFORMATION_REDUCER",
  ...
  RESET_LIST_OF_SOURCE_CONTENT_TO_UPDATE:
    "RESET_LIST_OF_SOURCE_CONTENT_TO_UPDATE",
  INCREMENT_SOURCE_CONTENT_UPDATE_COUNT:
    "INCREMENT_SOURCE_CONTENT_UPDATE_COUNT",
