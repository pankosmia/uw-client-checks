...
// components
import ToolsCards from '../js/components/home/toolsManagement/ToolsCards';
import HomeContainerContentWrapper from '../js/components/home/HomeContainerContentWrapper';
import {
  getTools,
  getIsUserLoggedIn,
...
class ToolsManagementContainer extends Component {
  constructor(props) {
    super(props);
    console.log("ToolsManagementContainer props:", props);
...
const getManifests = (state) => {
  ...
  for (const tool of tools || []) {
    ...
    let manifest = getSourceBookManifest(state, DEFAULT_ORIG_LANG_OWNER ); //getOriginalLangOwner(glOwner)
...
const mapDispatchToProps = (dispatch) => ({
  ...
  actions: {
    ...
    // },
    // setProjectToolGL: (toolName, selectedGL, owner, bookId = null) => {
    //   dispatch(ProjectDetailsActions.setProjectToolGL(toolName, selectedGL, owner, bookId));
    // },
