...
function UsfmExport() {
  ...
  return (
    <Box>
      ...
      <PanDialog
        titleLabel={doI18n(
          "pages:uw-client-checks:export_as_usfm",
          i18nRef.current,
        )}
        closeFn={() => handleClose()}
        isOpen={open}
        ...
        <DialogContent sx={{ mt: 1 }} style={{ overflow: "hidden" }}>
          <Box sx={{ maxHeight: "269px" }}>
            <DialogContentText>
              <Typography>
                {doI18n(
                  "pages:uw-client-checks:pick_one_or_more_books_export",
                  i18nRef.current,
                )}
              </Typography>
        ...
        <PanDialogActions
          ...
          actionFn={async () => {
            if (!selectedBooks || selectedBooks.length === 0) {
              enqueueSnackbar(
                doI18n(
                  "pages:uw-client-checks:no_books_selected",
                  i18nRef.current,
                ),
                { variant: "error" },
              );
          ...
          actionLabel={doI18n(
            "pages:uw-client-checks:export_label",
            i18nRef.current,
          )}
